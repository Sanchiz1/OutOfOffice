...
import { addToProject } from '../../API/projectRequests';
...
interface AddToProjectEmployeesDataTable {
  ProjectId: number
}

export default function AddToProjectEmployeesDataTable(props: AddToProjectEmployeesDataTable) {
  ...
  const AddUser = (employeeId: number) => {
    addToProject(ProjectId, employeeId).subscribe({
        next(value) {
            ShowSuccess(value);
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="left">
                      ...
                      <Button size='small' onClick={() => AddUser(row.id)}>Add</Button>
                    </TableCell>
                  </TableRow>
                );
              })}
